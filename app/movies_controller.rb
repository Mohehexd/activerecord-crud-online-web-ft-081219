...
def can_be_found_updated_and_saved
  ...
  emi_the_dimples = Movie.find_by(title: "Awesome Flick")
  emi_the_dimples.update(title: "Even Awesomer Flick")
  emi_the_dimples.save 
end

def can_update_using_update_method
  # Update movie title to "Wat, huh?"
  Movie.create(title: "Wat?")
  feathers = Movie.find_by(title: "Wat?")
  feathers.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  joseph = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  joseph.delete  
end
